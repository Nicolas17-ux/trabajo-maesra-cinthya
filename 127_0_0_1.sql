...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2020 a las 20:55:48
...
--
-- Base de datos: `libromuseo`
--
CREATE DATABASE IF NOT EXISTS `libromuseo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci;
USE `libromuseo`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `libro1`
--
...
--
-- Volcado de datos para la tabla `libro1`
--

INSERT INTO `libro1` (`id`, `autor`, `titulo`, `mensaje`, `fecha`) VALUES
(4, 'Denisse', 'sadsad', 'Prueba libro museo', 1587672329);
...
--
-- AUTO_INCREMENT de la tabla `libro1`
--
ALTER TABLE `libro1`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
('root', '[{\"db\":\"usuarios\",\"table\":\"libro1\"},{\"db\":\"coches\",\"table\":\"ocasion\"},{\"db\":\"usuarios\",\"table\":\"clientes\"},{\"db\":\"usuarios\",\"table\":\"usuario\"},{\"db\":\"usuarios\",\"table\":\"foro1\"},{\"db\":\"libromuseo\",\"table\":\"libro1\"}]');
...
('root', '2020-05-23 18:52:13', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
...
CREATE TABLE `clientes` (
  ...
  `edad` int(2) NOT NULL,
  `poblacion` varchar(12) COLLATE utf8_spanish_ci NOT NULL,
  `telefono` int(10) NOT NULL,
  `e_mail` varchar(25) COLLATE utf8_spanish_ci NOT NULL,
  `nom_usu` varchar(25) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `clientes` (`id`, `nombre`, `apellidos`, `edad`, `poblacion`, `telefono`, `e_mail`, `nom_usu`, `contrasena`) VALUES
(1, '', '', 0, '', 0, 'nicolascastillo076@gmail.', 'luis', 'antonio'),
(2, '', '', 0, '', 0, 'nicolascastillo076@gmail.', 'nicolas', 'password'),
(3, '', '', 0, '', 0, 'amadeuspolanco@gmail.com', 'joan', '1234'),
(4, '', '', 0, '', 0, 'amadeuspolanco@gmail.com', 'fernanda', 'fer123'),
(5, '', '', 0, '', 0, 'kimberlygamez@gmail.com', 'melany', '123'),
(6, '', '', 0, '', 0, 'samiramurua@gmail.com', 'samira', 'sami123'),
(7, '', '', 0, '', 0, 'nicolascastillo076@gmail.', 'leshly', 'lesh123'),
(9, '', '', 0, '', 0, 'nicolascastillo076@gmail.', 'Monica', 'mon123'),
(11, '', '', 0, '', 0, 'jaimebarreto@gmail.com', 'jaime', 'elaxom');
...
(9, 'samira', 'foro de prueba', '	hola', 1585686063, 0, 0);
...
INSERT INTO `libro1` (`id`, `autor`, `titulo`, `mensaje`, `fecha`) VALUES
(14, 'joan', 'dsdwdsa', '	dwqdqd', 1585949545),
(15, 'joan', 'dsdwdsa', '	dwqdqd', 1585949557);
...
INSERT INTO `usuario` (`id`, `nombre`, `apellidos`, `usuario`, `contrasena`, `email`) VALUES
(1, 'Nicolas', 'Romero', 'nicolas17', '81dc9bdb52d04dc20036dbd8313ed055', 'nicolascastillo076@gmail.con'),
(2, 'Nicolas', 'Romero', 'nicolas17', '81dc9bdb52d04dc20036dbd8313ed055', 'nicolascastillo076@gmail.con'),
(3, 'Nicolas', 'Romero', 'nicolas17', '81dc9bdb52d04dc20036dbd8313ed055', 'nicolascastillo076@gmail.con');
